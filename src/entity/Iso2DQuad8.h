...
struct Iso2DQuad8 : public IsoElement<8, 2> {
    ...
    QuickMatrix<8, 2>  getLocalShapeDerivative(Precision r, Precision s, Precision t) override;
    QuickMatrix<3, 16> computeStrainDisplacementRelationFromSource(QuickMatrix<8, 2> b_help) override;
